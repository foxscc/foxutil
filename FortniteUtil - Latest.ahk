...
Sys4Bg := MainGui.Add("Text", "x210 y290 w365 h45 Background" T_Col), ThemeOutlines.Push(Sys4Bg)
Sys4Tx := MainGui.Add("Text", "x212 y292 w361 h41 Center +0x200 cFFFFFF Background181818", "⚠️ FACTORY RESET")
Sys4Tx.OnEvent("Click", (*) => FactoryReset())
HoverMap[Sys4Tx.Hwnd] := Sys4Tx

TabContents[4].Push(Sys1Bg, Sys1Tx, Sys2Bg, Sys2Tx, Sys3Bg, Sys3Tx, Sys4Bg, Sys4Tx)
...
HoverEffect(Ctrl, isEntering) {
    if isEntering {
        ...
        if (Ctrl.Hwnd = Sys1Tx.Hwnd || Ctrl.Hwnd = Sys2Tx.Hwnd || Ctrl.Hwnd = Sys3Tx.Hwnd || Ctrl.Hwnd = Sys4Tx.Hwnd)
